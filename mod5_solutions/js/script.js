...
function buildAndShowHomeHTML(categories) {
  ...
  $ajaxUtils.sendGetRequest(
    homeHtmlUrl,
    function (homeHtml) {
      // Choose a random category from the main menu
      randomCategoryShortName = chooseRandomCategory(categories).short_name;

      // Update the homeHtml to use the random category
      var homeHtmlToInsertIntoMainPage = insertProperty(homeHtml, "randomCategoryShortName", randomCategoryShortName);
      insertHtml("#main-content", homeHtmlToInsertIntoMainPage);

      // Attach a click event handler for the "Specials" tile
      attachSpecialsTileClickEvent(randomCategoryShortName);
    },
    false
  );
}

// Function to attach the click event handler for the "Specials" tile
function attachSpecialsTileClickEvent(categoryShortName) {
